        ...
        if ($conn->query($sql) === TRUE) {
            ...
            if ($gasolinePrice != 0 || $dieselPrice != 0 || $LPGPrice != 0 || $elecPrice != 0 || $gas2 != 0 || $die2 != 0) {
                ...
                if (mysqli_num_rows($result0) > 0) {
                    ...
                    if ($row["gasolinePrice"] != $gasolinePrice || $row["dieselPrice"] != $dieselPrice || $row["lpgPrice"] != $LPGPrice || $row["electricityPrice"] != $elecPrice || $row["gasolinePrice2"] != $gas2 || $row["dieselPrice2"] != $die2) {
						$sql2 = "INSERT INTO finance(stationID,stationName,country,gasolinePrice,dieselPrice,lpgPrice,electricityPrice,gasolinePrice2,dieselPrice2,provider) VALUES('$stationID', '$stationName', '$country', '$gasolinePrice', '$dieselPrice', '$LPGPrice', '$elecPrice', '$gas2', '$die2', 'owner')";
